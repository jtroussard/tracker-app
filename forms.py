...
from wtforms import StringField, PasswordField, SubmitField, BooleanField, DateField, SelectField, FloatField, IntegerField
...
class TrackerEntryForm(FlaskForm):
    ...
    time_of_day = SelectField('Time of Day', choices=TIME_OF_DAY_CHOICES, validators=[DataRequired()])
